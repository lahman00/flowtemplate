...
export const PARTNER_MATERIAL_AUDIT: readonly PartnerMaterialAudit[] = [
  ...
  record({ company: "Kit", slug: "kit", programNetwork: "PartnerStack", currentStatus: "NOT_FOUND_IN_CURRENT_ACCOUNT", applicationStatus: "No application ever submitted", approvalStatus: "N/A", readiness: "NEEDS APPLICATION", evidence: [LIVE_VERIFICATION, "Full 20-row sweep of every partnership on PartnerStack account hello@miloosh.com (searched 'Kit' and 'Convert'), 2026-08-20: no Kit/ConvertKit application exists, pending or otherwise. Previously mis-tracked here as PENDING -- corrected. Real program is live on the marketplace ('Kit (formerly ConvertKit)', 50% recurring commission for customer's 1st year) -- a genuine unclaimed opportunity, not a stale wait."], lastVerifiedDate: "2026-08-20" }),
