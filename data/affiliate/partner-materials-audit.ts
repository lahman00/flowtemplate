...
export const PARTNER_MATERIAL_AUDIT: readonly PartnerMaterialAudit[] = [
  ...
  ...[["FreshBooks", "freshbooks"], ["ClickUp", "clickup"], ["Wrike", "wrike"], ["Zendesk", "zendesk"]].map(([company, slug]) => record({ company: company!, slug: slug!, programNetwork: "PartnerStack", currentStatus: "PENDING", applicationStatus: "Under review", approvalStatus: "Not approved", readiness: "PENDING APPROVAL", evidence: [STATUS_DRAFT], lastVerifiedDate: "2026-08-19" })),
