...
- **Known Commission Terms**:
  - Semrush ($200 CPA), LastPass (25%), RingCentral ($100), Nextiva ($150), Ecwid (20%), Craft Docs (20%), Keeper (10%), Moz ($25)
- **What You Need to Do**:
  1. Log into your Impact.com publisher account.
  2. Navigate to **Settings > Tax Documents** and submit electronic W-8BEN (or W-9).
  3. Enter bank account / PayPal payout details.
  4. Search each brand in the Marketplace and click **Apply / Join Campaign**.
  5. Once approved, copy the affiliate tracking URLs into `data/affiliate/active-partners.ts`.
...
- **Known Commission Terms**:
  - 15% to 30% recurring revenue share (Document360, Reclaim AI, Guru, Scribe, Nutshell, Keap, Front, Descript, Hotjar)
- **What You Need to Do**:
  1. Log into `dash.partnerstack.com` (using `hello@miloosh.com`).
  2. For pending programs (e.g. Reclaim AI, Document360, Guru), click into the application tab and select the monthly traffic bracket for Miloosh.
  3. Accept the updated PartnerStack publisher network terms.
  4. Select **"Publisher / Content Creator"** (not Implementation Agency) on category prompts.
...
- **Known Commission Terms**:
  - 25% first year on 1Password, up to $20 on Dashlane, up to $30/user on Google Workspace
- **What You Need to Do**:
  1. Complete registration on `signup.cj.com` with `hello@miloosh.com`.
  2. Verify email and complete phone/2FA verification.
  3. Submit electronic tax classification and direct deposit details.
  4. Search Advertiser CID `5140517` (1Password) and click Apply.
