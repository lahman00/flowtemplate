    ...
    <form onSubmit={handleSubmit} className={cn("flex w-full flex-col gap-3 sm:flex-row", className)}>
      <div className="relative flex-1">
        ...
        <input
          ...
          className="min-h-14 w-full rounded-xl border border-white/15 bg-white/5 pl-12 pr-5 text-white outline-none placeholder:text-zinc-500 focus:border-white/40 focus:bg-white/[0.07]"
        />
      </div>
